...
public class LdapConfiguration extends AbstractConfiguration {
     ...
     */
    private String uidAttribute = "dn";
    ...
    public String getAccountUserNameAttributes() {
        ...
        if(shortNameLdapAttributes != null && shortNameLdapAttributes.size() > 0){
        	return shortNameLdapAttributes.get(0);
        }
        return null;
    }

    public void setAccountUserNameAttributes(String accountUserNameAttribute) {
        accountConfig.setShortNameLdapAttributes(Arrays.asList(accountUserNameAttribute));
    }
